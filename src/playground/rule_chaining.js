...
const { getAccountInformation } = require("../api/account-api-client");

async function ruleChaining() {
  /**
   * Setup a new engine
   */
  ...
  const inviteRule = {
    ...
    priority: 5, // Set a lower priority for the inviteRule, so it runs later (default: 1)
  };
